window.ebenPage = {
    ...
    text: [
      `
        ...
        <br>
        <br>
        It was thought Eben would become an officer, or perhaps even a senator one day, but his desires and inclinations have led him down a different path—one his grandmother, Aemilia, has approved of and fostered with vigor.
        <br>
        <br>
        With Aemilia tending to the Lares of the family, she has always had a peripheral role when it comes to our patron god, Pluto. So when Eben expressed an interest in learning about him, Aemilia was happy to educate him, guiding him in the proper rites and quiet observances by which Pluto is honored on the estate.
        <br>
        <br>
        He took to the lessons quickly, so much so that he now tends the temple and leads the family when performing rituals and sacrifices. This vocation has also led him down a path of scholarly pursuits. While he does not take on the duties of a scribe, he is a keen reader, spending many hours in the library.
        <br>
        <br>
